'use strict'
// Note that whilst /v2/message is just a duplicate of /message this is a copy of the lib/functions/getMessage.js test file
// However when the meteoalarm work is completed this will need refactoring to address the changes to serve v2 data
...
let getMessage = require('../../../../lib/functions/v2/getMessage').getMessage
...
lab.experiment('getMessage v2', () => {
  ...
  lab.test('XsdSchema validation test: invalid alert', async () => {
    let consoleLogStub
    try {
      delete require.cache[require.resolve('../../../../lib/functions/v2/getMessage')]
      consoleLogStub = sinon.stub(console, 'log')
      const func = require('../../../../lib/functions/v2/getMessage').getMessage
      ...
      getMessage = require('../../../../lib/functions/v2/getMessage').getMessage
    }
  })
